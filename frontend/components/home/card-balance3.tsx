...
export const CardBalance3 = ({mostCommonTag}: {mostCommonTag: string}) => {
  return (
      ...
      <CardBody className="py-5">
        <div className="flex gap-2.5">
          ...
          <div className="flex flex-col">
            <span className="text-white">Most Common Tag</span>
            <span className="text-white text-xs"><Chip>{mostCommonTag}</Chip></span>
          </div>
        </div>
